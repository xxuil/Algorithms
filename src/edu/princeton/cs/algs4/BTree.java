...
public class BTree<Key extends Comparable<Key>, Value>  {
    ...
    public static void main(String[] args) {
        ...
        st.put("www.edu.princeton.cs.edu.princeton.edu", "128.112.136.12");
        st.put("www.edu.princeton.cs.edu.princeton.edu", "128.112.136.11");
        st.put("www.edu.princeton.edu",    "128.112.128.15");
        ...
        StdOut.println("edu.princeton.cs.edu.princeton.edu:  " + st.get("www.edu.princeton.cs.edu.princeton.edu"));
