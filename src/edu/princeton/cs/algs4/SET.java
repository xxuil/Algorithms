...
public class SET<Key extends Comparable<Key>> implements Iterable<Key> {
    ...
    public static void main(String[] args) {
        ...
        // insert some keys
        set.add("www.edu.princeton.cs.edu.princeton.edu");
        set.add("www.edu.princeton.cs.edu.princeton.edu");    // overwrite old value
        set.add("www.edu.princeton.edu");
        set.add("www.math.edu.princeton.edu");
        ...
        StdOut.println(set.contains("www.edu.princeton.cs.edu.princeton.edu"));
